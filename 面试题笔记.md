...
　　2）对于equals方法，注意：equals方法**不能**作用于基本数据类型的变量，equals继承Object类，比较的是是否是同一个对象![image-20210222012012622](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210222012012622.png)
...
4. 接口中的方法默认是 public abstract，也只能是这个类型。不能是 static，接口中的方法也不允许子类覆写，抽象类中允许有static 的方法
   ...
   ![image-20210228000729547](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210228000729547.png)
...
![image-20210302150442499](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210302150442499.png)
...
![image-20210302174638998](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210302174638998.png)
...
![image-20210302203911927](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210302203911927.png)
...
![image-20210303111421330](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210303111421330.png)

### 5.JSP内置作用域

![image-20210303112102738](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210303112102738.png)

### 6.过滤器和拦截器的区别

![img](https://images2017.cnblogs.com/blog/330611/201710/330611-20171023150730676-300068307.png)

![image-20210306205641327](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210306205641327.png)

这种有web中才能用过滤器

![image-20210307095324335](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210307095324335.png)
...
![img](https://images0.cnblogs.com/blog/33509/201304/28234015-f1cc175bc15c439d94abf7cb1c52ab97.png)
...
![img](https://images0.cnblogs.com/blog/33509/201304/28234054-ff92ae14bfe74da98c4deb8d7c78f2f8.png)
...
![img](https://images2015.cnblogs.com/blog/33509/201605/33509-20160507160034812-1769640827.png)
...
![image-20210303150947162](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210303150947162.png)
...
底层原理：当数据库数据较大的时候，当查询的时候采用索引可以节省很多的时间。mysql索引的底层实现索引的数据结构是B树或者B+树。也就是当建立索引的时候，系统就会建立一个索引文件存储在磁盘中，MyISAM引擎是采用b+树作为索引结构，b+树的特点就是所有的数据都是存储在叶子节点上，并且节点通过链表连接，查询数据顺序查找就行。InnoDB引擎是采用b树作为索引结构的，他是叶子节点和非叶子节点都有存储数据，方向从左往右上，数据由小变大，查找的方式是二分查找。
...
3.最后让从服务器中的relay-log全部吧sql语句执行一遍
...
![image-20210303212801972](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210303212801972.png)
...
![154218_inHA_1582989.jpg](http://static.oschina.net/uploads/space/2014/0916/154218_inHA_1582989.jpg)
...
![image-20210310112757992](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210310112757992.png)
...
![image-20210310152115181](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210310152115181.png)
...
![image-20210306150740661](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210306150740661.png)
...
4.execution([权限修饰符] [返回类型] [类全路径] [方法名称]([参数列表]) )![image-20210310144933210](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210310144933210.png)
...
![image-20210305142931220](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210305142931220.png)

读取配置文件     加载流     获取sqlsessionfactory对象

![image-20210305143214174](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210305143214174.png)
...
![image-20210305143637194](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210305143637194.png)

![image-20210305143743065](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210305143743065.png)

让我们探究sql是如何执行的

![image-20210305144310023](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210305144310023.png)
...
![image-20210305151650067](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210305151650067.png)
...
![image-20210305150134745](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210305150134745.png)
...
![image-20210305150547017](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210305150547017.png)
...
![image-20210305155246628](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210305155246628.png)
...
![image-20210306163828416](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210306163828416.png)

在web.xml中只是做了一个注册servlet（DispactherServlet），给配置配件传递过去  匹配那些请求，



![image-20210306164609245](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210306164609245.png)



添加处理映射器和处理器适配器  添加视图解析器

![image-20210306165232408](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210306165232408.png)

### 1.springmvc流程

![image-20210306171347286](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210306171347286.png)
...
![image-20210306175636796](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210306175636796.png)



![image-20210306175830201](C:\Users\王形友\Desktop\image-20210306175830201.png)

![image-20210306193700663](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210306193700663.png)

a=1，b=2可以传递进来，res=3

![image-20210306193901164](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210306193901164.png)

### 2.restful风格   用PathVariable传递值

![image-20210306194650892](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210306194650892.png)

设置传递的类型method  可以用GetMapping   PostMapping

![image-20210306195311813](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210306195311813.png)

### 3.重定向和转发



![image-20210306195655692](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210306195655692.png)

无需视图解析器，他的作用是将没有解析过的信息进行解析，比如尾部加上.jsp   所以这边将视图解析器注释掉也没有关系

![image-20210306195918641](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210306195918641.png)
...
![image-20210306205232078](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210306205232078.png)
...
![image-20210306210823024](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210306210823024.png)
...
![image-20210306212217415](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210306212217415.png)

json格式乱码  解决方式2

![image-20210306212409194](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210306212409194.png)
...
![image-20210307100142740](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210307100142740.png)

![image-20210307100343187](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210307100343187.png)
...
![image-20210307111758424](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210307111758424.png)
...
![image-20210307141154349](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210307141154349.png)
...
![image-20210307173020996](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210307173020996.png)
...
![image-20210307213115130](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210307213115130.png)

懒汉式

![image-20210307213314683](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210307213314683.png)
...
![image-20210308104352135](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210308104352135.png)
...
![image-20210309201858439](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210309201858439.png)

![image-20210309201914105](C:\Users\王形友\AppData\Roaming\Typora\typora-user-images\image-20210309201914105.png)
